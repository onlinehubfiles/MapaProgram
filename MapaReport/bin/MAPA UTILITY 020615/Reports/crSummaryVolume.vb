...
Public Class crSummaryVolume
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MapaReport.crSummaryVolume.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSummaryVolume
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSummaryVolume = New crSummaryVolume
        rpt.Site = Me.Site
        Return rpt
    End Function
